    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerRow}>
          <Image source={require("@/assets/images/logo_nobg.png")} style={styles.headerLogo} contentFit="contain" />
        ...
        <View style={styles.footer}>
          <Image source={require("@/assets/images/logo_nobg.png")} style={styles.footerLogo} contentFit="contain" />
